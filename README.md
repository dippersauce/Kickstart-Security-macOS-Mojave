# Kickstart Security: macOS Mojave
...
# Licensing
The book is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0). 

In simple terms, You are free to:
Share — copy and redistribute the material in any medium or format
Adapt — remix, transform, and build upon the material
The original author (me, dippersauce) cannot revoke these freedoms as long as you follow the license terms.
